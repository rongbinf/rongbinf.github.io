...
exports.toNumber = exports.fromNumber = void 0;
var _rixits = '0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_';
...
function fromNumber(number) {
    ...
    var result = '', rixit; // like 'digit', only in some non-decimal radix
